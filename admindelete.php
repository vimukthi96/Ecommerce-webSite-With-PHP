...
<div id="main">
	<div class="shell">
	<div id="content">
		<h3>Remove Product - Admin</h3>
		<a href="admin.php"><input type="button" value="Back" name="back"></a>
	</div>
		<div id="container" align="center">
			...
			<?php
			      ...
			      ?>  
							...
							<ul-->
								<li>		
									<form method="post" action="delete.php?action=remove&id=<?php echo $row["id"]; ?>">
 		                            <!--form method="post" action="cart1.php?action=add&id=<?php echo $row["id"]; ?>"-->
			                           ...
			                           <input type="submit" name="remove" style="margin-top:5px;" class="btn btn-default" value="Remove">
